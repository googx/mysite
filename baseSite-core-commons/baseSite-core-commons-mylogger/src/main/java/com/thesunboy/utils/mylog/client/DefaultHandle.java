...
import com.thesunboy.utils.mylog.utils.DateUtils;

/**
 * 
 * 如果用户没有实现该接口,将使用默认的处理器按照java平台中常用的system.out.print方法作为控制台的输出打印<br>
 * 
 * 
 * @author hx940929
 ...
 * @QQ 836845967
 */
public class DefaultHandle implements ILocalEnviConsole
{
