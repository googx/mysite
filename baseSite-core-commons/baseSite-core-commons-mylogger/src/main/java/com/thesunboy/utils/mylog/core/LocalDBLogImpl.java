 ...
 * 
 * @author hx940929
 * @CreateDate 2016-5-5 - 下午7:26:49
 * @ModifiedDate 2016-5-5 - 下午7:26:49
 * @Encoding UTF-8
 * @Version 1.0
 * @WebSite <a href="www.thesunboy.com">访问开发者主页</a>
 * @QQ 836845967
 */
public class LocalDBLogImpl extends AControlerLog
{

	@SuppressWarnings("rawtypes")
	public LocalDBLogImpl(Class clazz, LogConfiger configer)
	{
		super(configer);
